<fieldset class="gllpLatlonPicker" id="<?php echo 'dsa' ?>" <?php echo $this->htmlopt; ?>>
    ...
    <input type="hidden" name="<?php echo $this->name; ?>[gmap_longitude]" class="gllpLongitude" value="<?php echo $this->map_longitude; ?>"/>
    <input type="hidden" class="gllpZoom" value="<?php echo $this->Zoom ?>"/>
</fieldset>